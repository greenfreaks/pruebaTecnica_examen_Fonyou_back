...
CREATE TABLE `examenes` (
  ...
  `fecha_aplicacion` varchar(255) DEFAULT NULL,
  `hora_aplicacion` varchar(255) DEFAULT NULL,
  `nombre_examen` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id_examen`),
  KEY `FKccpiuyns0kd4mkgdbrqgtw99t` (`profesor_id`),
  CONSTRAINT `FKccpiuyns0kd4mkgdbrqgtw99t` FOREIGN KEY (`profesor_id`) REFERENCES `profesores` (`id_profesor`)
